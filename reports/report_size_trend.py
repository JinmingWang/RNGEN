...
for i, title in enumerate(metrics):
    ...
    ax.set_xlabel("Area Side Length (meters)", fontsize=font_size)
    ...
    # plt.tight_layout()
    # plt.savefig(f"reports/scale_{metric_titles[i]}.pdf", dpi=300)
    # plt.show()
...
plt.savefig("reports/scale.pdf", dpi=300)
plt.show()
