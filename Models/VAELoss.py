...
class VAELoss(nn.Module):
    ...
    def forward(self, reconstructed: torch.Tensor, original: torch.Tensor, z_mean: torch.Tensor,
        ...
        # Total loss is the sum of MSE loss and weighted KL divergence loss
